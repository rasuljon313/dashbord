      ...
      <div className="flex items-center justify-center min-h-screen flex-col bg-gray-200">
        ...
        <div className="w-full max-w-md bg-gray-300 rounded-2xl shadow-lg shadow-gray-400 p-8">
          <form onSubmit={submit} className="space-y-6">
            <div>
              <input
                className={`w-full px-4 py-3 border rounded-lg shadow-sm bg-gray-100 select-none placeholder-gray-600 focus:outline-none focus:ring-2 transition-all duration-300 ease-in-out ${error ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'}`}
                type="text"
                value={number}
                onChange={(e) => setNumber(e.target.value)}
                placeholder="Username"
