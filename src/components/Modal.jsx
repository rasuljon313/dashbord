...
const Modal = ({ isOpen, onClose, productData }) => {
    const [formData, setFormData] = useState(productData || { name: "", price: "", category: "", description: "" });
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#14141480] bg-opacity-50">
        <div className="relative w-full max-w-md p-4 rounded-lg shadow bg-gray-300">
          <div className="flex items-center justify-between p-4 border-b dark:border-gray-500">
            ...
            <button
              onClick={onClose}
              className="transition-all duration-300 hover:text-red-600 hover:bg-red-200 rounded-lg w-8 h-8 flex items-center justify-center dark:hover:text-red"
            >
          ...
          <form onSubmit={handleSubmit} className="p-4 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="block w-full p-2.5 text-sm dark:bg-gray-200 border rounded-lg border-none outline-none"
              ></textarea>
            </div>
            <button
              type="submit"
