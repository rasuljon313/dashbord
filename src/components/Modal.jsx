...
const Modal = ({ productData }) => {
  const {toggleIsOpen, setEditMode,editMode, selectedProduct, setSelectedProduct} = create()
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#14141480] bg-opacity-50">
      <div className="relative w-full max-w-md p-4 rounded-lg shadow bg-gray-300">
        <div className="flex items-center justify-between p-4 border-b dark:border-gray-500">
          ...
          <button onClick={closeModal} className="transition-all duration-300 cursor-pointer hover:text-red-600 hover:bg-red-200 rounded-lg w-8 h-8 flex items-center justify-center dark:hover:text-red">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <button
            type="submit"
            className="w-full px-5 py-2.5 cursor-pointer text-sm bg-gray-400 text-white rounded transition-all duration-400 hover:bg-gray-500">
